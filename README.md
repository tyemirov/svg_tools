...
* Letters render in per-letter bands aligned with the motion axis; band offsets are centered and spaced by glyph sizes with tracking, and vertical directions also add staggered offsets.
