...
* Letters render in per-letter bands aligned with the motion axis; band offsets are centered and spaced by glyph sizes with tracking, reversed for R2L/B2T so the first letter leads, and vertical directions also add staggered offsets.
